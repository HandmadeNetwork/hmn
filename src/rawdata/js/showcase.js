// NOTE(ben): Because this file is only used by old jam pages, we do a weird
// thing where all the exports from this module will be splatted onto `window`
// and therefore globally accessible like the old script used to do it.

import { makeTemplateCloner, emptyElement } from "./lib/templates";
...
export function makeShowcaseItem(timelineItem) {
...
export function initShowcaseContainer(container, items, rowHeight = 300, itemSpacing = 4) {
