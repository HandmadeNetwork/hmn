...
type Profile struct {
	...
	// supply a link.
	DocUrl        int64 `protobuf:"varint,15,opt,name=doc_url,json=docUrl,proto3" json:"doc_url,omitempty"` // Index into string table.
...
func (x *Profile) GetDocUrl() int64 {
	if x != nil {
		return x.DocUrl
	}
	return 0
...
const file_profile_proto_rawDesc = "" +
	"\n" +
	"\rprofile.proto\x12\x12perftools.profiles\"\x8e\x05\n" +
	"\aProfile\x12>\n" +
	...
	"\x13default_sample_type\x18\x0e \x01(\x03R\x11defaultSampleType\x12\x17\n" +
	"\adoc_url\x18\x0f \x01(\x03R\x06docUrl\"3\n" +
	"\tValueType\x12\x12\n" +
	...
	"\tis_folded\x18\x05 \x01(\bR\bisFolded\"S\n" +
	"\x04Line\x12\x1f\n" +
	...
	"\n" +
	"start_line\x18\x05 \x01(\x03R\tstartLineB-\n" +
	"\x1dcom.google.perftools.profilesB\fProfileProtob\x06proto3"
