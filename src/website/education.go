...
func EducationIndex(c *RequestContext) ResponseData {
	...
	tmpl := indexData{
		BaseData: getBaseTemplateData(c, "Handmade Education", nil),
		Courses: []templates.EduCourse{
			{
				Name: "Compilers",
				Slug: "compilers",
...
func EducationArticle(c *RequestContext) ResponseData {
	...
	tmpl := articleData{
		BaseData:  getBaseTemplateData(c, article.Title, nil),
...
func EducationArticleNew(c *RequestContext) ResponseData {
	...
	tmpl := adminData{
		editorData: getEditorDataForEduArticle(c.UrlContext, c.CurrentUser, getBaseTemplateData(c, "New Education Article", nil), nil),
	}
...
func EducationArticleEdit(c *RequestContext) ResponseData {
	...
	tmpl := adminData{
		editorData: getEditorDataForEduArticle(c.UrlContext, c.CurrentUser, getBaseTemplateData(c, "Edit Education Article", nil), article),
		Article:    templates.EducationArticleToTemplate(article),
	}
...
func EducationArticleDelete(c *RequestContext) ResponseData {
	...
	baseData := getBaseTemplateData(c, fmt.Sprintf("Deleting \"%s\"", article.Title), nil)
